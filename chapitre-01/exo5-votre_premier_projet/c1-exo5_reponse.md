...
## Creation du dossier MonEssai.    
Projects
------------------------------------------------------------
Name       Kind         Language   Test   External
==================================================
MonEssai   ConsoleApp   C++        No     No
...
C:\USERS\PC\ONEDRIVE\DESKTOP\NKENTSEU\MONPROJET
│   .gitignore
│   MonProjet.jenga
│   pyrightconfig.json
│   
...
└───Build
    ...
    └───Obj
        └───Debug-Windows
            └───MonEssai
                    Applications_MonEssai_main.obj
                    Applications_MonEssai_main.obj.d
                    Applications_MonEssai_main.obj.jenga_sig
## Construction
